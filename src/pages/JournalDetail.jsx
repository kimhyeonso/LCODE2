...
export default function JournalDetail() {
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.cover} style={{ "--cover-image": `url(${hero})` }}><span>BEST REVIEW</span><div><small>CITY EDITION　TOKYO 14:52</small><h1>TOKYO</h1><p>나를 조금씩 닮아가는 여행</p></div></section>
